...
const T = {
  es: {
    ...
    fanSub: (n: string) => `Cada línea fina es una persona. La zona dorada más intensa es donde está la mitad de los ${n} jugadores; la clara, casi todos. Si la zona baja, la gente está perdiendo dinero.`,
  ...
  en: {
    ...
    fanSub: (n: string) => `Each thin line is one person. The brighter gold area is where half of the ${n} players are; the light one, almost all of them. If the area goes down, people are losing money.`,
